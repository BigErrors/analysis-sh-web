...
<div id='peopleNum' class='shade'>
  ...
  <div class="businessNum_nav">
    <span class="businessNum_nav_span">首页 > 调解员数量分析</span>
  </div>
  <div class="businessNum_nav2">
    <span class="businessNum_nav2_span active"  @click="changeRouter('peopleNum')">数量分析</span>
    <span class="businessNum_nav2_span"  @click="changeRouter('peopleType')">属性分析</span>
    <span class="businessNum_nav2_span"  @click="changeRouter('peopleSearch')">画像分析</span>
  </div>
  <div class="businessNum_content">
    <div class="businessNum_content_top">
      <div class="businessNum_content_title clearfix">
        <div class="businessNum_content_title_left">
          <span class="businessNum_content_span1">调解员人数变化趋势</span>
        </div>
        <div class="businessNum_content_title_right">
          <div class="businessNum_content_span_container bg1">
            <span class="businessNum_content_span3" v-text="totalPeople"></span>
            <span class="businessNum_content_span4">调解员总数</span>
          </div>
        </div>
      </div>
    ...
    <div class="businessNum_content_top">
      <div class="businessNum_content_title clearfix">
        <div class="businessNum_content_title_left">
          <span class="businessNum_content_span1">历年新增人员趋势</span>
        </div>
        <div class="businessNum_content_title_right">
          <div class="businessNum_content_span_container bg1">
            <span class="businessNum_content_span3" v-text="newPeople"></span>
            <span class="businessNum_content_span4">新增人员（今年）</span>
          </div>
        </div>
      </div>
    ...
    <div class="businessNum_content_bottom">
      <div class="businessNum_content_title clearfix">
        <div class="businessNum_content_title_left">
          <span class="businessNum_content_span1">各区调解员人数</span>
        </div>
      </div>
    ...
    <div class="businessNum_content_bottom">
      <div class="businessNum_content_title clearfix">
        <div class="businessNum_content_title_left">
          <span class="businessNum_content_span1">各区新增调解员</span>
        </div>
      </div>
...
<style scoped>
  ...
  .businessNum_content_top:first-child{
    margin-right: 14px;
  }
  ...
  .businessNum_content_bottom:last-child{
    margin-left: 14px;
  }
